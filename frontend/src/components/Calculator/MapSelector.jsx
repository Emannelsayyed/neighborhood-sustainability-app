...
const MapSelector = ({ onPolygonSelected, onAreaCalculated }) => {
  ...
  // Use the local variable instead of state for event handlers
  newMap.on(window.L.Draw.Event.CREATED, (e) => {
    const { layer } = e;
    drawnItemsLayer.clearLayers();
    drawnItemsLayer.addLayer(layer);
    processDrawnLayerLocal(layer);
  });
  ...
  // Set state after everything is set up
    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 mt-2">
          ...
          {coordinates.length > 0 && ` Selected area: ${coordinates.length - 1} points`}
        </p>
      </div>
        ...
        <div className="mb-4 p-4 bg-blue-50 rounded">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="font-bold">{area.area_sqm.toLocaleString()} m²</div>
            </div>
            <div>
