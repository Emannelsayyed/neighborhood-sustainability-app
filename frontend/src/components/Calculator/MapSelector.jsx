...
const MapSelector = ({ onPolygonSelected, onAreaCalculated, onSatelliteImage }) => {
      ...
      {showConfirmation && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-600 mb-6">Process environmental data for the selected area?</p>
